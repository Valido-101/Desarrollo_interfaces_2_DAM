...
namespace Practica_2_interfaces.miagendaDataSetTableAdapters {
    ...
    public partial class agendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Practica_2_interfaces.Properties.Settings.Default.miagendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO `agenda` (`id`, `nombre`, `año`) VALUES (@p1, @p2, @p3)";
        ...
        public virtual int Crear_agenda(int p1, string p2, int p3) {
    ...
    public partial class tareaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT `id_agenda`, `dia`, `mes`, `descripción`, `lugar` FROM `tarea`";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `tarea` (`id_agenda`, `dia`, `mes`, `hora`, `descripción`, `lugar`) V" +
            ...
            this._commandCollection[3].CommandText = "SELECT descripción, dia, id_agenda, lugar, mes FROM tarea WHERE (id_agenda = @p1)" +
                " AND (dia = @p2) AND (mes = @p3)";
            ...
            this._commandCollection[4].CommandText = "SELECT descripción, dia, id_agenda, lugar, mes FROM tarea WHERE (id_agenda = @p1)" +
                "";
        ...
        public virtual int Eliminar_tarea(int p1, int p2, int p3, int p4) {
            global::MySql.Data.MySqlClient.MySqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((int)(p1));
            command.Parameters[1].Value = ((int)(p2));
            command.Parameters[2].Value = ((int)(p3));
