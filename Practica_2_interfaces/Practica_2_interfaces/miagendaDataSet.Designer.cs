...
namespace Practica_2_interfaces.miagendaDataSetTableAdapters {
    ...
    public partial class tareaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4].CommandText = "SELECT `id_agenda`, `dia`, `mes`, `hora`, `descripción`, `lugar` FROM `tarea` WHE" +
        ...
        public virtual int FillBy(miagendaDataSet.tareaDataTable dataTable, int p1) {
        ...
        public virtual miagendaDataSet.tareaDataTable Get_tareas_agenda_concreta(int p1) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(p1));
            miagendaDataSet.tareaDataTable dataTable = new miagendaDataSet.tareaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int Crear_tarea(int p1, int p2, int p3, object p4, string p5, string p6) {
            global::MySql.Data.MySqlClient.MySqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(p1));
