...
namespace Practica_2_arreglo {
    ...
    public partial class miagendaDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationid_agenda_foranea;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationid_agenda_foranea = this.Relations["id_agenda_foranea"];
        }
        ...
        private void InitClass() {
            ...
            this.relationid_agenda_foranea = new global::System.Data.DataRelation("id_agenda_foranea", new global::System.Data.DataColumn[] {
                        this.tableagenda.idColumn}, new global::System.Data.DataColumn[] {
                        this.tabletarea.id_agendaColumn}, false);
            this.Relations.Add(this.relationid_agenda_foranea);
        }
        ...
        public partial class agendaDataTable : global::System.Data.TypedTableBase<agendaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public agendaRow AddagendaRow(int id, string nombre, int annio) {
            ...
            private void InitClass() {
                ...
                this.columnnombre.MaxLength = 99;
        ...
        public partial class tareaDataTable : global::System.Data.TypedTableBase<tareaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tareaRow AddtareaRow(agendaRow parentagendaRowByid_agenda_foranea, int dia, int mes, int hora, string descripcion, string lugar) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        descripcion,
                        lugar};
                if ((parentagendaRowByid_agenda_foranea != null)) {
                    columnValuesArray[0] = parentagendaRowByid_agenda_foranea[0];
                }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tareaRow FindByid_agendadiameshora(int id_agenda, int dia, int mes, int hora) {
            ...
            private void InitClass() {
                ...
                this.columndescripcion.MaxLength = 99;
                this.columnlugar.AllowDBNull = false;
                this.columnlugar.MaxLength = 99;
            }
        ...
        public partial class agendaRow : global::System.Data.DataRow {
            ...
            public int annio {
                get {
                    return ((int)(this[this.tableagenda.annioColumn]));
                }
                set {
            ...
            public tareaRow[] GettareaRows() {
                if ((this.Table.ChildRelations["id_agenda_foranea"] == null)) {
                    return new tareaRow[0];
                }
                else {
                    return ((tareaRow[])(base.GetChildRows(this.Table.ChildRelations["id_agenda_foranea"])));
                }
            }
        }
        ...
        public partial class tareaRow : global::System.Data.DataRow {
            ...
            public agendaRow agendaRow {
                get {
                    return ((agendaRow)(this.GetParentRow(this.Table.ParentRelations["id_agenda_foranea"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["id_agenda_foranea"]);
                }
            }
        }
...
namespace Practica_2_arreglo.miagendaDataSetTableAdapters {
    ...
    public partial class agendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO `agenda` (`id`, `nombre`, `annio`) VALUES (@p1, @p2, @p3)";
            ...
            this._commandCollection[2].CommandText = "SELECT MAX(id)+1 FROM agenda";
        ...
        public virtual int crearAgenda(int p1, string p2, int p3) {
    ...
    public partial class tareaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `tarea` (`id_agenda`, `dia`, `mes`, `hora`, `descripcion`, `lugar`) V" +
                "ALUES (@p1, @p2, @p3, @p4, @p5, @p6)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            ...
            this._commandCollection[2] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "DELETE FROM `tarea` WHERE ((`id_agenda` = @p1) AND (`dia` = @p2) AND (`mes` = @p3" +
                ") AND (`hora` = @p4))";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@p1";
            ...
            this._commandCollection[3].CommandText = "UPDATE `tarea` SET `hora`=@p4, `descripcion` = @p5, `lugar` = @p6 WHERE ((`id_age" +
                "nda` = @p7) AND (`dia` = @p8) AND (`mes` = @p9) AND (`hora` = @p10))";
            ...
            this._commandCollection[4].CommandText = "SELECT COUNT(*) FROM `tarea` WHERE `id_agenda`=@p1 AND `dia`=@p2 AND `mes`=@p3";
            ...
            this._commandCollection[5].CommandText = "SELECT `id_agenda`, `dia`, `mes`, `hora`, `descripcion`, `lugar` FROM `tarea` WHE" +
                "RE `id_agenda`=@p1";
            ...
            this._commandCollection[6].CommandText = "SELECT `id_agenda`, `dia`, `mes`, `hora`, `descripcion`, `lugar` FROM `tarea` WHE" +
        ...
        public virtual int setTareasAgendaConcreta(miagendaDataSet.tareaDataTable dataTable, int p1) {
        ...
        public virtual miagendaDataSet.tareaDataTable getTareasAgendaConcreta(int p1) {
            this.Adapter.SelectCommand = this.CommandCollection[5];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(p1));
            miagendaDataSet.tareaDataTable dataTable = new miagendaDataSet.tareaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int setTareasAgendaDiaConcreto(miagendaDataSet.tareaDataTable dataTable, int p1, int p2, int p3) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual miagendaDataSet.tareaDataTable getTareasAgendaDiaConcreto(int p1, int p2, int p3) {
            this.Adapter.SelectCommand = this.CommandCollection[6];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(p1));
            this.Adapter.SelectCommand.Parameters[1].Value = ((int)(p2));
            this.Adapter.SelectCommand.Parameters[2].Value = ((int)(p3));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p5, string p6, int p7, int p8, int p9, int p10, string p11, string p12) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int crearTarea(int p1, int p2, int p3, int p4, string p5, string p6) {
            global::MySql.Data.MySqlClient.MySqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(p1));
        ...
        public virtual int eliminarTarea(int p1, int p2, int p3, int p4) {
            global::MySql.Data.MySqlClient.MySqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((int)(p1));
            command.Parameters[1].Value = ((int)(p2));
            command.Parameters[2].Value = ((int)(p3));
        ...
        public virtual int modificarTarea(int p4, string p5, string p6, int p7, int p8, int p9, int p10) {
            ...
            command.Parameters[6].Value = ((int)(p10));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
